...
- **R Validation Hub**. Author.

- **Doug Kelkhoff**. Author.

- **Marly Gotti**. Author.

- **Eli Miller**. Maintainer, author.

- **Kevin K**. Author.

- **Yilong Zhang**. Author.

- **Eric Milliman**. Author.

- **Juliane Manitz**. Author.

- **Mark Padgham**. Contributor.

- **PSI special interest group Application and Implementation of
  Methodologies in Statistics**. Copyright holder.
