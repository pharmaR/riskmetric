...
riskmetric has a variety of metrics for many package sources. Each metric is not implemented for every package source. This table below shares the metrics that are currently implemented by source type. 
